...
=======
  bart_variables_select_obj = var_selection_by_permute_response_three_methods(bart_machine, plot = FALSE)
>>>>>>> 200fe6abafd2cf310d12c729686339cba754d543
...
#   write.csv(rep_results[, , nr], file = paste("partial_var_sel_sim_friedman_uniform_p", p, "_sigsq_", sigsq, "_nr_", nr, "_revised.csv", sep = ""))  
  write.csv(rep_results[, , nr], file = paste("partial_var_sel_sim_friedman_uniform_p", p, "_sigsq_", sigsq, "_nr_", nr, "_bart_gmax.csv", sep = ""))  
