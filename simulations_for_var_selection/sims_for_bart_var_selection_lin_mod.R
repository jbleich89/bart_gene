...
rep_results = array(NA, c(10, 2, num_replicates))
...
rownames(results) = c("BART_CV", "BART_pointwise", "BART_simul_max", "BART_simul_se", "stepwise_backward",  "stepwise_forward", "lasso", "RF_point", "RF_simul", "RF_CV") 
...
#save results
write.csv(results, file = paste("../bart_gene/simulations_for_var_selection/sim_results/B_prior_var_sel_sim_linear_p", p, "_p0_", p0, "_sigsq_", sigsq, ".csv", sep = ""))
